<script setup>
const totalUnpaid = localStorage.getItem(["total UnPaid Invoice"]);
...
<template>
    <div class="col-span-12 lg:col-span-6 xl:col-span-3 ">
        <div class="card mb-0 shadow-lg rounded-lg">
            <div class="flex justify-between items-center mb-2">
                <div>
                    <span class="block text-surface-900 dark:text-surface-0 -color mb-2 text-2xl font-medium">n/a</span>
                ...
                <div class="flex items-center justify-center bg-orange-100 dark:bg-orange-400/10 rounded-full"
                    ...
                    <i class="pi pi-bolt text-orange-400 !text-xl"></i>
                </div>
            </div>
        </div>
    </div>
    <!-- <div class="col-span-12 lg:col-span-6 xl:col-span-3 shadow-lg rounded-lg">
        <div class="card mb-0">
            <div class="flex justify-between items-center mb-2">
                <div>
                    <span class="block text-surface-900 dark:text-surface-0   font-medium mb-2 text-2xl">___</span>
    ...
    <div class="col-span-12 lg:col-span-6 xl:col-span-3 ">
        <div class="card mb-0 shadow-lg rounded-lg">
            <div class="flex justify-between items-center mb-2">
                <div>
                    <span class="block text-surface-900 dark:text-surface-0  font-medium mb-2 text-2xl">{{ totalUnpaid
                        || 0 }}</span>
