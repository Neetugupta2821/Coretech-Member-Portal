...
<template>
    <div class="mb-4">
        <div class="col-span-12 xl:col-span-12 mb-6">
            <span class="text-3xl font-medium">Geo Definitions</span>
        </div>
    </div>
    <div v-animateonscroll="{ enterClass: 'animate-fadein', leaveClass: 'animate-fadein' }"
        ...
        <div class="card mt-8 shadow-lg rounded-lg">
            <div class="flex justify-between col-span-12 xl:col-span-12 mb-6">
                <span class="text-2xl font-medium">Geo Definitions</span>
            ...
            <div class="mt-6">
                <DataTable ref="dt" v-model:selection="selectedProducts" :value="products" dataKey="id"
                    ...
                    <Column field="Definition" header="Definition" sortable style="min-width: 8rem" class="text-medium">
                    </Column>
    ...
    <div class="card flex justify-center">
        <Drawer v-model:visible="visibleRight" header="Create Geo Definition" position="right"
            class="!w-full md:!w-80 lg:!w-[30rem]">
            <h3 class="font-bold mb-2">General Information</h3>
            <div class="flex flex-wrap justify-start gap-0">
                <label>Friendly Name</label>
                <InputText type="text" v-model="value" class="w-full mb-2" placeholder="ACME Inc. Def." />
                <label>Definitions
                </label>
                <InputText type="text" v-model="value" class="w-full mb-2" placeholder="Search for a Definitions" />
            </div>
            <template #footer>
