...
<template>
    <div class="mb-4">
        <div class="col-span-12 xl:col-span-12 mb-6">
            <span class="text-3xl font-medium">flowProxy: Challenge Templates</span>
        </div>
    ...
    <div v-animateonscroll="{ enterClass: 'animate-fadein', leaveClass: 'animate-fadein' }"
        ...
        <div class="card mt-8 shadow-lg rounded-lg">
            <div class="flex justify-between col-span-12 xl:col-span-12 mb-6">
                <span class="text-2xl font-medium">Challenge Template Overview </span>
                <div class="col-span-1">
                    <Button label="Create New Challenge" icon="pi pi-plus" class="flex-auto" severity="success"
            ...
            <div class="mt-6">
                <DataTable ref="dt" v-model:selection="selectedProducts" :value="products" dataKey="id"
                    ...
                    <Column field="CustomName" header="Custom Name" style="min-width: 8rem" sortable>
