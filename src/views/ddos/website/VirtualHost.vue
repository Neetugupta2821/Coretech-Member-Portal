...
<template>
    <div class="mb-4">
        <div class="col-span-12 xl:col-span-12 mb-6">
            <span class="text-3xl font-medium">flowProxy: Virtual Hosts</span>
        </div>
    ...
    <div v-animateonscroll="{ enterClass: 'animate-fadein', leaveClass: 'animate-fadein' }"
        ...
        <div class="card mt-8 shadow-lg rounded-lg">
            <div class="flex justify-between col-span-12 xl:col-span-12 mb-6">
                <span class="text-2xl font-medium">Virtual Host Overview
                </span>
                <div class="col-span-1">
                    <Button label="Create New Virtual Host" icon="pi pi-plus" class="flex-auto" severity="success"
            ...
            <div class="grid grid-cols-4 gap-4">
                ...
                <div class="col-span-1">
                    <Select v-model="selectedCity" size="small" :options="cities" optionLabel="name"
                        placeholder="Challenge All Mode" class="" />
                </div>
            </div>
            <div class="mt-6">
                <DataTable ref="dt" v-model:selection="selectedProducts" :value="products" dataKey="id"
                    ...
                    <Column field="Certificate" header="Certificate" style="min-width: 8rem" sortable></Column>
                    <Column field="ChallengeMode" header="Challenge:mode" style="min-width: 8rem" sortable></Column>
                    <Column field="ChallengeID" header="Challenge: Template ID" style="min-width: 8rem" sortable></Column>
                    <Column field="RequestMode" header="Requests: Mode" style="min-width: 8rem" sortable></Column>
                    <Column field="RequestsID" header="Requests: Template ID" style="min-width: 8rem" sortable></Column>
