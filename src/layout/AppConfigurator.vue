...
const primaryColors = ref([
    { name: 'noir', palette: {} },
    { name: 'orange', palette: { 50: '#fff7ed', 100: '#ffedd5', 200: '#fed7aa', 300: '#fdba74', 400: '#fb923c', 500: '#f97316', 600: '#fb923c', 700: '#fb923c', 800: '#fb923c', 900: '#fb923c', 950: '#431407' } },

    { name: 'emerald', palette: { 50: '#fef5f2', 100: '#ffedd5', 200: '#fed7aa', 300: '#fdba74', 400: '#fb923c', 500: '#EE9537', 600: '#fb923c', 700: '#eb643f', 800: '#e84f25', 900: '#da4117', 950: '#c03914' } },
...
const surfaces = ref([
    {
        name: 'slate',
        palette: { 0: '#ffffff', 50: '#e2e8f0', 100: '#f1f5f9', 200: '#e2e8f0', 300: '#cbd5e1', 400: '#94a3b8', 500: '#64748b', 600: '#475569', 700: '#334155', 800: '#1e293b', 900: '#191f34', 950: '#0c0f1a' }
    },
    {
        name: 'navy',
        palette: { 0: '#ffffff', 50: '#f8fafc', 100: '#f1f5f9', 200: '#e2e8f0', 300: '#cbd5e1', 400: '#94a3b8', 500: '#64748b', 600: '#475569', 700: '#334155', 800: '#1e293b', 900: '#1d243c', 950: '#151a2b' }
    },
    {
        name: 'gray',
...
updateColors('surface', surfaces.value[0]);
</script>
                ...
                <div class="pt-2 flex gap-2 flex-wrap justify-between">
                    <button v-for="surface of surfaces" :key="surface.name" type="button" :title="surface.name"
                        @click="updateColors('surface', surface)" :class="[
                            ...
                            { 'outline-primary': layoutConfig.surface ? layoutConfig.surface === surface.name : isDarkTheme ? surface.name === 'slate' : surface.name === 'slate' }
